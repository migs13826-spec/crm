        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            {formData.password && (
              <div className="space-y-1">
                ...
                <p className="text-xs text-gray-500">{strength.level}</p>
              </div>
            )}
          </div>
          <div className="space-y-2">
          ...
          <div className="flex items-start gap-2">
            <input
              type="checkbox"
              id="terms"
              className="mt-1 h-4 w-4 rounded border-gray-300 text-indigo-500 focus:ring-indigo-500"
              checked={formData.agreedToTerms}
              onChange={(e) => setFormData({ ...formData, agreedToTerms: e.target.checked })}
            />
            <Label htmlFor="terms" className="text-xs text-gray-500 font-normal leading-5">
              I agree to the{" "}
